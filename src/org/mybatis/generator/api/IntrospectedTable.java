...
//        setSelectByPrimaryKeyStatementId("selectByPrimaryKey"); //$NON-NLS-1$
        setSelectByPrimaryKeyStatementId("findByPrimaryKey"); //$NON-NLS-1$
    ...
    protected String calculateMyBatis3XmlMapperFileName() {
        StringBuilder sb = new StringBuilder();
        sb.append("mybatis-"); //$NON-NLS-1$
        String value = fullyQualifiedTable.getDomainObjectName(); 
        sb.append(value.substring(0, 1).toLowerCase() + value.substring(1));
